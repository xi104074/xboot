...
static spisd_interface_t * _io = NULL;
...
spisd_result_t spisd_init(spisd_interface_t * io) {
...
spisd_result_t spisd_write_block(uint32_t sector, uint8_t *buffer) {
...
spisd_result_t spisd_write_multi_block(uint32_t sector, uint8_t *buffer, uint32_t num_sectors) {
